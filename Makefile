...
SOURCES            = main.c myLib.c counters.c spritesheet.c  splash.c Lose.c Win.c Pause.c bg.c draw.c update.c Instructions.c text.c font.c IntroSong.c MainSong.c PauseSong.c WinSong.c sound.c collisionmap.c Intro.c  Intro2.c Water.c Jump.c Crunch.c LoseSong.c
DKPATH             = C:/Users/Bree~/Documents/School/CS2261/WindowsdevkitARM/devkitARM/bin
CCPATH             = C:/cygwin64/bin
VBASIM             = C:/Users/Bree~/Documents/School/CS2261/vba/vba.exe
FIND               = find
COPY               = cp -r
